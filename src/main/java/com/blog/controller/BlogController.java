...
public class BlogController {
	...
	public String getBlogsInfo(ModelMap map, String msg, HttpServletRequest req) {
		...
		List<Blog> blogList = service.selectAlls(pageNow, displayCount);
		int maxCount = service.getCount(displayCount);
		int pageCount = maxCount % displayCount == 0 ? maxCount / displayCount
				: maxCount / displayCount + 1;
	...
	public String addBlogInfo(Blog blog, ModelMap map,HttpServletRequest req) {
		int pageNow = Integer.parseInt(req.getParameter("pageNow"));
	...
	public String editBlog(Blog blog, ModelMap map,HttpServletRequest req) {
		int pageNow=Integer.parseInt(req.getParameter("pageNow"));
